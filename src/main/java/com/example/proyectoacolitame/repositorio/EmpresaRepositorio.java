...
public interface EmpresaRepositorio extends JpaRepository<Empresa,Integer> {
    ...
    @Query(value="select empresa.id_empresa,empresa.nombre,facebook,twitter,instagram from empresa,administrador_empresa where administrador_empresa.id_empresa=empresa.id_empresa and id_administrador=?1",nativeQuery = true)
